<template>
  <nav>
    <span class="wrapIcons">
      <v-menu
        class="alarms"
        v-model="localAlertOn"
        :close-on-content-click="false"
        location="end top"
        origin="auto"
      >
        <template
          v-slot:activator="localAlertOn"
          location="end center"
          origin="auto"
        >
          <font-awesome-icon
      ...
      >
        ...
        >
          <font-awesome-icon
            ...
            @click.prevent="toggleTown"
          />
        </template>
        <TownValidation :townValid="partyStore.townAuthorized" />
      </v-menu>
    </span>
    <span class="wrapIcons">
      <font-awesome-icon
